...
/***/ "./wwwroot/ts/PictureOrner/GetUsersAnswer.ts":
/*!***************************************************!*\
  !*** ./wwwroot/ts/PictureOrner/GetUsersAnswer.ts ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./wwwroot/ts/PictureOrner/SendPicture.ts":
/*!************************************************!*\
  !*** ./wwwroot/ts/PictureOrner/SendPicture.ts ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   SendPicture: () => (/* binding */ SendPicture)
/* harmony export */ });
class SendPicture {
    constructor(signalR) {
        this.sendPictureId = () => {
            ...
            if (sendPictureElement != null) {
                sendPictureElement.onclick = async () => {
                    const pictureId = document.getElementById("picture_id").value;
...
/***/ "./wwwroot/ts/PictureOrner/SendUserPoints.ts":
/*!***************************************************!*\
  !*** ./wwwroot/ts/PictureOrner/SendUserPoints.ts ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   SendUserPoints: () => (/* binding */ SendUserPoints)
/* harmony export */ });
...
class SendUserPoints {
    constructor() {
        this.SendPoints = () => {
            const sendPointsElement = document.getElementById("send_points");
            const answerElements = document.getElementsByClassName("answer");
            if (sendPointsElement != null) {
                sendPointsElement.onclick = () => {
                    let pointEntityList = [];
                    Array.from(answerElements).forEach(answerElement => {
                        const answerId = answerElement.querySelector('.answer_id').value;
                        const point = answerElement.querySelector('.point').value;
                        pointEntityList.push({
                            AnswerId: answerId,
                            Point: point
                        });
                    });
                    this.Send(pointEntityList).then((data) => {
                        const result = JSON.parse(data);
                        window.alert(result.message);
                    });
                };
        ...
        this.Send = async (pointEntityList) => {
            const fetchApi = new _root_share_FetchApi__WEBPACK_IMPORTED_MODULE_0__.FetchApi();
            return await fetchApi.send(this.url, this.method, this.headers, pointEntityList, this.responseKind).then(async (data) => {
                return data;
            }).catch(e => {
                throw e;
            });
...
"use strict";
/*!******************************************!*\
  !*** ./wwwroot/ts/PictureOrner/Index.ts ***!
  \******************************************/
__webpack_require__.r(__webpack_exports__);
...
/* harmony import */ var _SendPicture__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./SendPicture */ "./wwwroot/ts/PictureOrner/SendPicture.ts");
/* harmony import */ var _SendUserPoints__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./SendUserPoints */ "./wwwroot/ts/PictureOrner/SendUserPoints.ts");
/* harmony import */ var _GetUsersAnswer__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./GetUsersAnswer */ "./wwwroot/ts/PictureOrner/GetUsersAnswer.ts");
...
(() => {
    ...
    signalR.activate();
    new _SendPicture__WEBPACK_IMPORTED_MODULE_2__.SendPicture(signalR);
    const getUsersAnswer = new _GetUsersAnswer__WEBPACK_IMPORTED_MODULE_4__.GetUsersAnswer();
    const sendUserPoints = new _SendUserPoints__WEBPACK_IMPORTED_MODULE_3__.SendUserPoints();
...
/******/ })()
;
//# sourceMappingURL=PictureOrner.js.map