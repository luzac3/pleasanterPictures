...
/***/ "./wwwroot/ts/PictureUser/Canvas.ts":
/*!******************************************!*\
  !*** ./wwwroot/ts/PictureUser/Canvas.ts ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./wwwroot/ts/PictureUser/GetPicture.ts":
/*!**********************************************!*\
  !*** ./wwwroot/ts/PictureUser/GetPicture.ts ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class GetPicture {
    constructor() {
        this.GetPicture = async (signalR) => {
            signalR.get("ReceivePictureId", async (pictureId) => {
                const parsedPictureId = pictureId;
...
/***/ "./wwwroot/ts/PictureUser/PictureOverlay.ts":
/*!**************************************************!*\
  !*** ./wwwroot/ts/PictureUser/PictureOverlay.ts ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   PictureOverlay: () => (/* binding */ PictureOverlay)
/* harmony export */ });
class PictureOverlay {
    ...
    async composeImage() {
        if (!this.overlayImage || !this.overlayCanvas) {
            throw new Error('�I�[�o�[���C�摜�܂��̓L�����o�X��������܂���');
        }
...
/***/ "./wwwroot/ts/PictureUser/SendAnswer.ts":
/*!**********************************************!*\
  !*** ./wwwroot/ts/PictureUser/SendAnswer.ts ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _PictureOverlay__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./PictureOverlay */ "./wwwroot/ts/PictureUser/PictureOverlay.ts");


class SendAnswer {
    constructor() {
        this.SendCanvas = async () => {
            const sendElement = document.getElementById('send');
            sendElement.onclick = async () => {
                let dataUrl = "";
                const canvasElement = document.getElementById('textCanvas');
                if (!canvasElement) {
                    const pictureOverlay = new _PictureOverlay__WEBPACK_IMPORTED_MODULE_1__.PictureOverlay();
...
"use strict";
/*!*****************************************!*\
  !*** ./wwwroot/ts/PictureUser/Index.ts ***!
  \*****************************************/
__webpack_require__.r(__webpack_exports__);
...
/* harmony import */ var _SendAnswer__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./SendAnswer */ "./wwwroot/ts/PictureUser/SendAnswer.ts");
/* harmony import */ var _Canvas__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Canvas */ "./wwwroot/ts/PictureUser/Canvas.ts");
/* harmony import */ var _GetPicture__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./GetPicture */ "./wwwroot/ts/PictureUser/GetPicture.ts");
...
(() => {
    ...
    signalR.activate();
    new _Canvas__WEBPACK_IMPORTED_MODULE_4__.Canvas();
    const getPicture = new _GetPicture__WEBPACK_IMPORTED_MODULE_5__.GetPicture();
    const sendAnswer = new _SendAnswer__WEBPACK_IMPORTED_MODULE_3__.SendAnswer();
...
/******/ })()
;
//# sourceMappingURL=PictureUser.js.map