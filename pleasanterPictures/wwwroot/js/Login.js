...
/***/ "./wwwroot/ts/Login/GenerateQr.ts":
/*!****************************************!*\
  !*** ./wwwroot/ts/Login/GenerateQr.ts ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class GenerateQr {
    constructor() {
        this.generate = () => {
            ...
            const url = document.getElementById("qr_input");
            if (qrObj) {
                new QRCode(qrObj, {
                    text: url.value,
                    width: 128,
...
/***/ "./wwwroot/ts/Login/GetRegister.ts":
/*!*****************************************!*\
  !*** ./wwwroot/ts/Login/GetRegister.ts ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _GenerateQr__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./GenerateQr */ "./wwwroot/ts/Login/GenerateQr.ts");
/* harmony import */ var _GetRegister__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./GetRegister */ "./wwwroot/ts/Login/GetRegister.ts");



(() => {
    const signalR = new _root_share_SignalR__WEBPACK_IMPORTED_MODULE_0__.SignalR();
    const generateQr = new _GenerateQr__WEBPACK_IMPORTED_MODULE_1__.GenerateQr();
    const getRegister = new _GetRegister__WEBPACK_IMPORTED_MODULE_2__.GetRegister();
    signalR.activate();
    generateQr.generate();
