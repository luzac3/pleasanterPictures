        ...
        private PictureEntity? SetPictureEntity(TablesEntity? tablesEntity)
        {
            ...
            else
            {
                ...
                PictureEntity pictureEntity = new(
                    ...
                    pictureImage: !string.IsNullOrEmpty(pictureImageBase64) ? tablesEntity.ReferenceId.ToString() : "", // 画像IDを格納
                    pictureImageOverlay: !string.IsNullOrEmpty(imageOverlayBase64) ? tablesEntity.ReferenceId.ToString() : "", // 画像IDを格納
